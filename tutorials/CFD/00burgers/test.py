...
class Decoder(nn.Module):
    ...
    def forward(self, z):
        ...
        loc_scale = torch.exp(self.fc22(hidden))
...
class VAE(nn.Module):
    ...
    def model(self, x):
        ...
        with pyro.plate("data", x.shape[0]):
            ...
            pyro.sample("obs", dist.Normal(loc_img, loc_scale).to_event(1), obs=x.reshape(-1, 784))
...
def main(args):
    ...
    train_loader = setup_data_loaders(MNIST, use_cuda=args.cuda, batch_size=256)

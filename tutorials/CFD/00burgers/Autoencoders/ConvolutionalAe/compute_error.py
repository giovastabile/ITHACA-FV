...
err_pred = snapshots_predicted.reshape((n_test, 3, domain_size, domain_size))
...
err_snap = err_snap.reshape((n_test, 3, domain_size, domain_size))
...
err_snap_proj_true = err_snap_proj_true.reshape((n_test, 3, domain_size, domain_size))

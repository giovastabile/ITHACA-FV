...
LevenbergMarquardt<FunctorType>::minimize(FVectorType  &x)
{
    ...
    if (status==LevenbergMarquardtSpace::ImproperInputParameters) {
      ...
      Info << " #################### DEBUG ~/OpenFOAM/OpenFOAM-v2006/applications/utilities/ITHACA-FV/src/thirdparty/Eigen/unsupported/Eigen/src/LevenbergMarquardt/LevenbergMarquardt.h, line 283 #################### " << endl;
      return status;
    }
    do {
